...
Page({
  data: {
    ...
    // 投诉类别数据源（恢复原来的10个选项）
    categories: [
      { id: '1', name: '宽带/宽带网速不达标（实测速率远低于签约带宽）' },
      { id: '2', name: '宽带/频繁断网或连接不稳定' },
      { id: '3', name: '网络延迟高、丢包严重，影响在线应用' },
      { id: '4', name: 'WiFi信号覆盖差或家庭组网效果不佳' },
      { id: '5', name: '合约期内无法降档或更改低资费套餐' },
      { id: '6', name: '提前解约违约金过高或计算不合理' },
      { id: '7', name: '订购/退订/销户流程复杂、被故意拖延或设置障碍' },
      { id: '8', name: '客服推诿扯皮、问题久拖不决' },
      { id: '9', name: '装机或维修服务超时、多次预约不上' },
      { id: '10', name: '强制捆绑销售（如绑定手机卡、路由器合约）' }
    ],
    index: -1, // -1 表示未选择
